    ...
    return (
        <ScrollView>
            <View style={{ backgroundColor: '#fff' }}>
                <Text style={{ textAlign: 'center', color: '#000', fontSize: 16 }}>MyCalendar</Text>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', borderColor: '#000', borderWidth: 0.5, borderRadius: 10, marginHorizontal: 10, paddingHorizontal: 8, paddingVertical: 6 }}>
                ...
                {
                    selectedPopUp ?
                        <View style={{ backgroundColor: '#fff', marginHorizontal: 10, marginVertical: 20, paddingHorizontal: 10, paddingVertical: 10, borderColor: 'grey', borderWidth: 0.5, borderRadius: 10, shadowColor: 'green', shadowOffset: { width: 2, height: 2 }, shadowOpacity: 10, shadowRadius: 2, elevation: 10 }}>
                            ...
                            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View style={{ borderWidth: 0.5, borderColor: 'grey', marginTop: 10, width: '50%' }}>
                                    <View style={{ paddingHorizontal: 10, paddingVertical: 5, marginHorizontal: 10, marginVertical: 15, borderRadius: 6 }}>
                                        <Text style={{ color: '#000', textAlign: 'center', fontSize: 16, fontWeight: 'bold' }}>Lunch</Text>
                                    </View>
                                    <TouchableOpacity style={{ backgroundColor: 'red', paddingHorizontal: 10, paddingVertical: 5, marginHorizontal: 10, marginVertical: 8, borderRadius: 6 }}>
                                        <Text style={{ color: '#fff', textAlign: 'center' }}>Cancle Tiffin</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ backgroundColor: 'green', paddingHorizontal: 10, paddingVertical: 5, marginHorizontal: 10, marginVertical: 8, borderRadius: 6 }}>
